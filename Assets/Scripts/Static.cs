...
public static class Static
{
    ...
    private static bool? m_usesUnity = null;
    public static bool UsesUnity
    {
        get
        {
            // if (m_usesUnity is null) assign whether unity is used.
            m_usesUnity ??= Assembly.GetExecutingAssembly().GetName().Name == "Assembly-CSharp";
            return (bool)m_usesUnity;
        }
    }
